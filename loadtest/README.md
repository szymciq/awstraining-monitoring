...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin 615299738092.dkr.ecr.eu-central-1.amazonaws.com
```
...
```
docker tag backend-loadtest:latest 615299738092.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```

```
docker push 615299738092.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
